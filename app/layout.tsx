  ...
  return (
    <html lang="en">
      <body className="relative bg-black text-white">
        {/* Base grid so you always see something */}
        <div
          aria-hidden="true"
        ...
        {/* Topo contour lines (bright + no extra opacity) */}
        <div
          aria-hidden="true"
          className="absolute inset-0 pointer-events-none"
          style={{
