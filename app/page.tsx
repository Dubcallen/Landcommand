  ...
  return (
    <main className="bg-[#1B1B1B] text-[#EFECE0]">
      ...
      <section className="relative isolate min-h-screen w-full overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center pt-28 text-center">
          <Image
            ...
            className="mb-4"
          />
          {/* Thin luxury serif (Playfair 400 via layout.tsx) */}
      ...
      <section className="mx-auto max-w-6xl px-6 py-16">
        ...
        {/* Placeholder grid — swap to your data later */}
            ...
            >
              ...
              <div className="p-5">
                <p className="text-white/75">
                  Long-form, legacy-grade property features.
                </p>
              </div>
            </a>
          ))}
      ...
      <section className="mx-auto max-w-6xl px-6 py-16">
        <div className="mb-6">
          ...
          <p className="mt-2 text-white/75 max-w-3xl">
            Fixed-fee listings with premium creative and national exposure. Keep
      ...
      <section className="mx-auto max-w-6xl px-6 py-16">
        <div className="mb-6">
          ...
          <p className="mt-2 text-white/75 max-w-3xl">
            Full-service land representation, negotiation, and closing.
            (Visibility can be feature-flagged until licensed.)
          </p>
        </div>
        <a
          href="/brokerage"
          className="inline-block rounded-xl border border-white/25 px-6 py-3 text-white hover:bg-white/10"
        >
          List with Brokerage
        </a>
      </section>
